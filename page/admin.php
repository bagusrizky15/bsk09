			...
			<div class="position-sticky">
				<div class="list-group list-group-flush mx-3 mt-4">
					<ul id="collapseExample1" class="collapse show list-group list-group-flush">
						...
						<li class="list-group-item py-1">
							<a href="admin.php?page=data-setor"><span class="fa fa-handshake" aria-hidden="true"></span> Transaksi Setor</a>
						</li>

						<li class="list-group-item py-1">
							<a href="admin.php?page=data-tarik"><span class="fa fa-handshake" aria-hidden="true"></span> Transaksi Tarik</a>
						</li>
