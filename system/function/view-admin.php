...
<body>
  ...
  <div class="form-group">
    ...
    <input type="text" style="cursor: not-allowed;" name="nama" disabled="disabled"
      value="<?php echo $row['nama'] ?> " />
  </div>
  <div class="form-group">
    <label class="">Nomor Telepon</label>
    <input type="text" style="cursor: not-allowed;" name="telepon" disabled="disabled"
      value="<?php echo $row['telepon'] ?>" required />
  </div>
  <div class="form-group">
    <label class="">Password</label>
    <input type="password" style="cursor: not-allowed;" name="password" disabled="disabled"
      value="<?php echo $row['password'] ?>" required />
  </div>
  <div class="form-group">
    <label class="">Level Admin</label>
    <input type="text" style="cursor: not-allowed;" disabled="disabled" name="level"
