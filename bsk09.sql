...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 22, 2022 at 04:23 PM
...
('ADM171201', 'Sukma', '08562741754', 'sukma@gmail.com', 'admin123', 'Master-admin');
...
('NSB1712001', 'Ihsmi ', 2, 'Jl. murai 8, C.45/4', '085617287718', 'ihsmiica@gmail.com', 'user123', 90000, 10),
...
(26, '2022-02-10', 'NSB1712001', 'HVS', 10, 9000, 90000, 'ADM171201');
...
--
ALTER TABLE `setor`
  MODIFY `id_setor` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
